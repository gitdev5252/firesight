      ...
      <div className="bg-[rgba(255,255,255,0.02)] rounded-[20px] border border-[rgba(255,255,255,0.1)] backdrop-blur-[32px] pt-[82px] pl-[81px] pb-[100px] pr-[117px] md:mx-[56px]">
        ...
        <div className="pl-[40px] pt-[82px] text-center">
          ...
          <p className="text-white text-start mt-[20px] text-[17.6px]">
            ...
            technology (powering
            <span className="font-extrabold">Firesight | Pulse</span>) are just
            a few of the projects currently underway at Firesight. Each reflects
            our commitment to building useful, context-aware systems that meet
            the evolving needs of modern professionals; irrespective of whether
            they reach it to the market.{" "}
          </p>
          <p className="text-white text-start mt-[20px] text-[17.6px]">
            At Firesight, we remain dedicated to carefully aligning
            technological exploration with meaningful real-world applications.
            As we design, prototype, iterate, and refine, our ultimate vision is
            clear: to create accessible tools that empower professionals and
            SMEs to manage information more effectively,{" "}
            <span className="font-extrabold">
