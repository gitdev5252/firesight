    ...
    <>
      ...
      <div className="flex justify-start flex-col md:px-14 px-4">
        ...
        <div className="flex justify-between items-center flex-wrap ">
          ...
          <p className="text-white md:w-[40%] w-full sm:text-[16px] text-[14px]">
      ...
      <div className="flex w-full relative 2xl:h-[1400px] md:h-[1100px] sm:px-auto px-4 sm:mt-auto mt-[20px]">
        <Link
          href="/sessions/start-session"
          className="z-[99999] sm:w-auto w-full"
        >
          <Button
            variant="outline"
            className="green-gradient-border-btn sm:text-[22px] text-[20px] px-[35px] py-[25px] sm:w-auto w-full !text-white md:ml-14 font-bold"
          >
            Try for Free
          </Button>
        </Link>
        <div className="flex justify-center items-center w-full absolute z-[9999]">
          <div
            className="w-[51px] h-[31px] sm:block hidden cursor-pointer"
