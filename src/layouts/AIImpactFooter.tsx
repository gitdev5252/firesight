  ...
  return (
    <>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><Link href="/dashboard" className="hover:underline"> <Image
                  src="/images/footer-icons/chat.svg"
                  alt="Chat Icon"
                  className="inline-block mr-1"
                  width={13}
                  height={13}
                ...
                <li><Link href="/news" className="hover:underline"><Image
                  src="/images/footer-icons/news.svg"
                  alt="News Icon"
                  className="inline-block mr-1"
                  width={13}
                  height={13}
                />News</Link></li>
                <li><Link href="/work" className="hover:underline"><Image
                  src="/images/footer-icons/news.svg"
                  alt="News Icon"
                  className="inline-block mr-1"
                  width={13}
                  height={13}
                />Work</Link></li>
                <li><Link href="/graph" className="hover:underline"><Image
                  src="/images/footer-icons/graph.svg"
                  alt="Graph Icon"
                  className="inline-block mr-1"
                  width={13}
                  height={13}
                />Graph</Link></li>
                <li><Link href="/pulse" className="hover:underline"><Image
                  src="/images/footer-icons/pulse.svg"
                  alt="Pulse Icon"
                  className="inline-block mr-1"
                  width={13}
                  height={13}
      ...
      <div className="w-full relative m-0 overflow-hidden hidden md:block lg:hidden">
        {children}
        <div className="footer-box py-12 relative overflow-hidden p-8">
          <div className="px-8 font-mono">
            ...
            <div className="grid grid-cols-3 gap-8 items-start mb-8">
                ...
                <div className="flex gap-3 mb-6 mt-6">
                  <div className="flex justify-center gap-4">
                    ...
                    <Link href="/" aria-label="cb">
                      <Image src="/images/icons/cb.svg" alt="cb" width={40} height={40} />
                    </Link>
                    <Link href="https://twitter.com/FiresightAi/" aria-label="Twitter">
                      <Image src="/images/icons/x.svg" alt="X" width={40} height={40} />
                    </Link>
                    <Link href="https://www.discord.com/" aria-label="Discord">
                      <Image src="/images/icons/discord.svg" alt="Discord" width={40} height={40} />
                    </Link>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-start ml-8">
                ...
                <ul className="space-y-1 text-base text-white">
                  <li><Link href="/dashboard" className="hover:text-[#A0AEC0] flex items-center"><Image src="/images/footer-icons/chat.svg" alt="Chat Icon" width={18} height={18} className="inline-block mr-2" />Chat</Link></li>
                  <li><Link href="/news" className="hover:text-[#A0AEC0] flex items-center"><Image src="/images/footer-icons/news.svg" alt="News Icon" width={18} height={18} className="inline-block mr-2" />News</Link></li>
                  <li><Link href="/work" className="hover:text-[#A0AEC0] flex items-center"><Image src="/images/footer-icons/work.svg" alt="Work Icon" width={18} height={18} className="inline-block mr-2" />Work</Link></li>
                  <li><Link href="/graph" className="hover:text-[#A0AEC0] flex items-center"><Image src="/images/footer-icons/graph.svg" alt="Graph Icon" width={18} height={18} className="inline-block mr-2" />Graph</Link></li>
                  <li><Link href="/pulse" className="hover:text-[#A0AEC0] flex items-center"><Image src="/images/footer-icons/pulse.svg" alt="Pulse Icon" width={18} height={18} className="inline-block mr-2" />Pulse</Link></li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center mb-8">
              <div className="flex items-center w-full justify-center mb-2">
                <Image src="/images/D vinci.svg" alt="D'VINCI GROUP" width={250} height={250} />
              </div>
            </div>
      ...
      <div className="w-full relative m-0 overflow-hidden block md:hidden">
        {children}
        <div className="footer-box relative overflow-hidden">
          <div className="relative flex flex-col text-white px-8 space-y-8">
            {/* Logo */}
            ...
            <div className="grid grid-cols-2 gap-12 w-full max-w-sm">
              {/* Left Column: Pricing with icons */}
              <div className="space-y-4">
                <div className="font-bold text-sm flex">Pricing</div>
                <div className="font-bold text-sm flex">Solutions</div>
                <div className="font-bold text-sm flex">About Us</div>
                <div className="font-bold text-sm flex">Product</div>
                <div className="font-bold text-sm flex">Desktop App</div>
                <div className="font-bold text-sm flex">Professional Development Hub</div>
              </div>

              {/* Right Column: Dashboard with icons */}
              <div className="space-y-4">
                <div className="font-bold text-sm flex "><Image src="/images/footer-icons/dashboard.svg" alt="Dashboard Icon" width={16} height={16} className="inline-block mr-2" />Dashboard</div>
                <div className="font-bold text-sm flex "><Image src="/images/footer-icons/chat.svg" alt="Chat Icon" width={16} height={16} className="inline-block mr-2" />Chat</div>
                <div className="font-bold text-sm flex "><Image src="/images/footer-icons/news.svg" alt="News Icon" width={16} height={16} className="inline-block mr-2" />News</div>
                <div className="font-bold text-sm flex "><Image src="/images/footer-icons/work.svg" alt="Work Icon" width={16} height={16} className="inline-block mr-2" />Work</div>
                <div className="font-bold text-sm flex "><Image src="/images/footer-icons/graph.svg" alt="Graph Icon" width={16} height={16} className="inline-block mr-2" />Graph</div>
                <div className="font-bold text-sm flex "><Image src="/images/footer-icons/pulse.svg" alt="Pulse Icon" width={16} height={16} className="inline-block mr-2" />Pulse</div>
              </div>
            </div>
            <hr className="border-t border-[#23263A] my-6 w-full" />
            ...
            <hr className="border-t border-[#23263A] w-full" />
            ...
            <div className="text-center space-y-3">
              ...
              <div className="space-y-2 text-xs text-[#A0AEC0] mmb-6">
