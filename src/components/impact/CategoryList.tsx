...
export default function CategoryList({ categories }: CategoryListProps) {
  return (
    <div
      className={`flex flex-col sm:flex-row flex-wrap justify-around md:gap-y-9 gap-y-1 gap-x-5 text-white font-bold lg:text-2xl text-[16px] leading-normal h-[800px] overflow-y-auto md:pr-[40px] md:mb-[40px] mb-[10px]`}
    >
